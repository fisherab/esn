...
public class ProductType {
	...
	public static final String Item0 = "ProductType.Item0";
	public static final String Item1 = "ProductType.Item1";
	public static final String Item2 = "ProductType.Item2";
	public static final String Item3 = "ProductType.Item3";

	public static final String Menu0 = "ProductType.Menu0";
	public static final String Menu1 = "ProductType.Menu1";
	public static final String Menu2 = "ProductType.Menu2";
	public static final String Menu3 = "ProductType.Menu3";
	...
	public ProductTypeTransferObject getTransferObject() {
		...
		return new ProductTypeTransferObject(this.id, this.name, this.shortD,
				this.longD, this.notes, this.spec, this.price, this.popularity,
				images, videos, menu, this.numberInStock, this.numberReserved,
				this.hidden, this.tags, this.weight, this.large);
	}
